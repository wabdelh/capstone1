    ...
    private fun addSecondaryBabyEmail(){
        ...
        FirebaseDatabase.getInstance().getReference("Babies").child(babyKey).addListenerForSingleValueEvent(object :
            ...
            override fun onDataChange(d: DataSnapshot) {
                ...
                FirebaseDatabase.getInstance().getReference("Babies").child(babyKey).setValue(baby).addOnSuccessListener {
                    Toast.makeText(this@Invite, "Secondary Email has been added successfully!", Toast.LENGTH_LONG).show()
                }.addOnFailureListener{
                    Toast.makeText(this@Invite, "Failed to add Email", Toast.LENGTH_LONG).show()
                }
            }
    ...
    private fun addTertiaryBabyEmail(){
        ...
        FirebaseDatabase.getInstance().getReference("Babies").child(babyKey).addListenerForSingleValueEvent(object :
            ...
            override fun onDataChange(d: DataSnapshot) {
                ...
                FirebaseDatabase.getInstance().getReference("Babies").child(babyKey).setValue(baby).addOnSuccessListener {
                    Toast.makeText(this@Invite, "Tertiary Email has been added successfully!", Toast.LENGTH_LONG).show()
